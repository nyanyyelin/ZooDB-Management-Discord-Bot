...
- Find the food expired between 
SELECT food_supply_id, supply_name
from food_supply
WHERE  expiration_date BETWEEN '2023-02-01' AND '2023-04-01';


-- Find Employee Info and their total work hours
SELECT employee.emp_id,employee.first_name,employee.last_name, time_sheet.total_hours
FROM employee
JOIN time_sheet
WHERE employee.emp_id = time_sheet.emp_id;
...
-- Zoo Expenses between the dates 
SELECT SUM(cost) FROM zoo_expense
